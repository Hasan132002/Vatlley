...
<section class="cta-section">
    <div class="container">
        <div class="cta-content">
            <h2>Transform Population Health with Data Intelligence</h2>
            <p>Learn how VettlyGlobal's population health analytics can improve outcomes, control costs, and advance health equity.</p>
