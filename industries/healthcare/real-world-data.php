...
<section class="section" style="background: url('<?php echo ASSETS_URL; ?>/images/product-img.jpg') center center / cover no-repeat; color: white; padding: 60px 0;">
    <div class="container" style="text-align: center;">
        <h2 style="color: white; margin-bottom: 20px;">Leverage Real-World Evidence for Better Health</h2>
        <p style="color: rgba(255,255,255,0.95); margin-bottom: 30px; font-size: 1.1rem;">
            Discover how VettlyGlobal's real-world data solutions can drive clinical research, inform evidence-based medicine, and improve patient outcomes.
        </p>
