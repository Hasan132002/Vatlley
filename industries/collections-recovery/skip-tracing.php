...
<section class="section" style="background: url('<?php echo ASSETS_URL; ?>/images/cyber-security-img.jpg') center center / cover no-repeat fixed; position: relative;">
    ...
    <div class="container" style="position: relative; z-index: 1;">
        <div style="text-align: center; max-width: 800px; margin: 0 auto;">
            <h2 style="color: white; font-size: 1.8rem; margin-bottom: 15px;">Ready to Accelerate Your Collections?</h2>
            <p style="font-size: 1.05rem; margin-bottom: 25px; color: rgba(255,255,255,0.95);">Transform your skip tracing operations with VettlyGlobal's advanced debtor location solutions.</p>
