...
<section class="cta-section">
    <div class="container">
        <div class="cta-content">
            <h2>Reduce Fraud, Improve Profitability</h2>
            <p>Get started with our fraud detection solution and see measurable results in your loss ratios within 90 days.</p>
