...
<section class="cta-section">
    <div class="container">
        <div class="cta-content">
            <h2>Ensure Sanctions Compliance</h2>
            <p>Comprehensive sanctions screening with real-time list updates and intelligent matching. Protect your institution with global sanctions and PEP screening.</p>
