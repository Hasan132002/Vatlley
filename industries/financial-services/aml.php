...
<section class="cta-section">
    <div class="container">
        <div class="cta-content">
            <h2>Strengthen Your AML Compliance Program</h2>
            <p>Deploy advanced AML solutions designed for modern financial institutions. Reduce false positives, accelerate investigations, and ensure regulatory compliance.</p>
