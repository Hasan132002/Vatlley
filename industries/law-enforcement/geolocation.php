    ...
    <div class="container">
        <div class="cta-box" style="text-align: center; max-width: 800px; margin: 0 auto;">
            ...
            <p style="font-size: 1.15rem; margin-bottom: 35px; color: rgba(255,255,255,0.95);">
                Locate devices with precision for emergency response, missing persons recovery, and criminal investigations with real-time tracking and historical analysis.
            </p>
