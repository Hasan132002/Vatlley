...
<section class="section" style="background: url('<?php echo ASSETS_URL; ?>/images/product-img.jpg') center center / cover no-repeat; padding: 80px 0; color: white;">
    <div class="container">
        <div style="text-align: center; max-width: 800px; margin: 0 auto;">
            <h2 style="font-size: 2.2rem; margin-bottom: 25px;">Ready to Manage Small Business Risk?</h2>
            <p style="font-size: 1.15rem; margin-bottom: 40px; opacity: 0.95;">
                Discover how VettlyGlobal's small business risk solutions can help you make better lending decisions and reduce portfolio losses.
            </p>
